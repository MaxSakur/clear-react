...
import { Button, DownArrow, UpArrow } from "../UI";
...
export const VerticalCarousel = ({
  ...
  const inactiveDownArrow =
    startArray >= (itemsArray.length - maxItemsCount) * carouselItemHeight;
  ...
  return (
    <>
      ...
      <div className={styles.verticalCarouselContainer}>
        ...
        />
        <Button onClick={changeModalView} value={ADD_NEW_CATEGORY} />
      </div>
    </>
  );
};
